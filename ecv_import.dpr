...
{					for l := 0 to Mangas.Count - 1 do
					...
					c := c + '<li><div style="clear: both;"><a href="#" onclick="build_ulist(this, ' + its(i + 1) + ', ' + its(j) + ')">[=]</a> ' + Source[j] + ' <a href="javascript:arch_import([files[' + us + ']], ''' + strsafe(urlencode(uo)) + ''')">&rarr;</a></div>' + p + '</li>'#13#10;
